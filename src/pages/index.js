      ...
      <Columns centered>
        <Columns.Column narrow textAlignment="centered">
          ...
          <Container className="personal-links">
            <a href="https://github.com/amadavan/"><FontAwesomeIcon icon={faGithub} fixedWidth/></a>
            <a href="https://scholar.google.com/citations?user=Oqqtb00AAAAJ&hl=en"><FontAwesomeIcon
              icon={faReact} fixedWidth/></a>
            <a href="https://orcid.org/0000-0002-1016-0118"><FontAwesomeIcon icon={faOrcid} fixedWidth/></a>
          </Container>
        </Columns.Column>
      </Columns>
    </MainPanel>
